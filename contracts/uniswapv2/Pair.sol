...
contract Pair is IPair, ERC20Permit {
  ...
  constructor() ERC20("Uniswap V2", "UNI-V2") ERC20Permit("UNI-V2") {
    factory = msg.sender;
  }
  ...
  function swap(
    ...
    uint balance1;
    {
      ...
      if (data.length > 0)
        ICallee(to).uniswapV2Call(msg.sender, amount0Out, amount1Out, data);
      balance0 = IERC20(_token0).balanceOf(address(this));
      balance1 = IERC20(_token1).balanceOf(address(this));
    }
